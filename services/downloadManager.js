...
const YANDEX_PROMO_TEXT =
  ...
  '🎁 <b>Яндекс дарит 300₽ на баланс телефона</b>, за установку поиска по умолчанию.\n' +
  'Занимает 1 минуту, деньги приходят сразу.\n' +
  '<i>(Работает только с телефона, если Яндекс еще не стоял по умолчанию)</i>';
